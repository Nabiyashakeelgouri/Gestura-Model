...
from translation.sentence_builder import correct_sentence


# ===================== STABLE TTS USING gTTS =====================
# ===================== STABLE TTS USING gTTS =====================
...
static_model.load_state_dict(torch.load("models/static_cnn_model.pth"))
static_model.eval()
...
dynamic_model.load_state_dict(torch.load("models/dynamic_model.pth"))
dynamic_model.eval()
...
while True:
    ...
    if active:
        ...
        if len(sequence) == 30:
            ...
            detected_word = None
            if conf > 0.45:  # lowered threshold
